...
library(EpiModelHIV)
library(EpiModelHPC)
# devtools::install_github("statnet/ergm.ego-private",ref="3.7-compat", auth_token ="6d639a0cc6f41f53bac0592bdec4874d3072e2a5")
...
save(sim, file = "~/Models/SHAMP/sim.rda")
demog.table<-as.data.frame(rbind(demog4,demog52,demog104,demog208,demog312,demog416,demog520))
save(demog.table, file = "~/Models/SHAMP/demogs.rda")



library(xlsx) #load the package
write.xlsx(x = demog.table, file = "~/Models/SHAMP/demogs.xlsx",
