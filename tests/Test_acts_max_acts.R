...
test_acts_max_acts<-netsim(est, param, init, control)

##Outside of package
save(test_acts_max_acts, file = "~/EpiModelHIV_shamp_modeling/scenarios/test_acts_max_acts.rda")

##Run the Check



table(test_acts_max_acts$attr[[1]]$inf.class)
table(test_acts_max_acts$attr[[1]]$status,test_acts_max_acts$attr[[1]]$race)

test_acts_max_acts$epi$i.prev[,1][1040]
