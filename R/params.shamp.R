...
param_shamp <- function(race.method = 1,
                      ...
                      ##Fraction never to test from Martina via NHANES.
                      ##Using total for Everyone 59+ (rates are not consistent with NSFG).
                      ##May evealuate further later. 
                      ##Will use current supression for SEattle King COunty as full suppression.
                      ##MSMF are assumed to have the same ttraj as msf.
                      #tt.traj.B.f.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.BI.f.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.H.f.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.HI.f.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.W.f.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.B.msf.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.BI.msf.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.H.msf.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.HI.msf.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.W.msf.prob = c(0.741, 0.000, 0.356, 0.567),
                      ...
                      #tt.traj.B.msmf.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.BI.msmf.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.H.msmf.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.HI.msmf.prob = c(0.741, 0.000, 0.356, 0.567),
                      #tt.traj.W.msmf.prob = c(0.741, 0.000, 0.356, 0.567),
                      
                      ##Init probabilities waiting to hear from Sara GLick. 
                      ...
                      ##WE STILL NEED VI RATES
                      #base.vi.main.B.rate = ,
                      #base.vi.main.BI.rate = ,
                      #base.vi.main.H.rate = ,
                      #base.vi.main.HI.rate = ,
                      #base.vi.main.W.rate = ,
                      #base.vi.pers.B.rate = ,
                      #base.vi.pers.BI.rate = ,
                      #base.vi.pers.H.rate = ,
                      #base.vi.pers.HI.rate = ,
                      #base.vi.pers.W.rate = ,
                      ai.scale = 1,
                      vi.scale = 1,
                      ...
                      cond.pers.always.prob.msm = 0.001,
                      ...
                      cond.inst.always.prob.msm = 0.001,
                      ...
                      #cond.main.B.prob.het = ,
                      #cond.main.BI.prob.het = ,
                      #cond.main.H.prob.het = ,
                      #cond.main.HI.prob.het = ,
                      #cond.main.W.prob.het = ,
                      #cond.pers.always.prob.het = 0.001,
                      #cond.pers.B.prob.het = ,
                      #cond.pers.BI.prob.het = ,
                      #cond.pers.H.prob.het = ,
                      #cond.pers.HI.prob.het = ,
                      #cond.pers.W.prob.het = ,
                      #cond.inst.always.prob.het = 0.001,
                      #cond.inst.B.prob.het = ,
                      #cond.inst.BI.prob.het = ,
                      #cond.inst.H.prob.het = ,
                      #cond.inst.HI.prob.het = ,
                      #cond.inst.W.prob.het = ,
                      #cond.always.prob.corr.het = 0.001,
